...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $q="SELECT * FROM user where email=? AND pin=?";
...
<body>
    ...
    <nav id="navbar">
        <div class="container">
     <h1 class="logo" > <a href="indexx.php"></a> HBW</h1>
     <ul>
...
<p><?php  echo $error;?></p>
    ...
    <input type="submit" style="width: 90%;padding: 8px;background-color: lightgreen;margin-top: 30px;"S>
    </form>
</div>