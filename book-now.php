...
<p><form action="" method="post">
          <center><p>PLease complete your booking with us</p></center>
          <br>
                ...
                <b>number:</b><input type="text"name="email"placeholder="how many are you?"size="60"><br>
                    <b>room:</b><select name="room" id="s">
                    <option select >choose favourable room type</option>
                    <option>1 king room</option>
                    <option>double room(2 beds)</option>
                    <option>2 different room</option>
                    </select>
                    <br>
                   
            <b>check-in:<input type="date" placeholder="Check-in"><br>
            <b>check-out:<input type="date" placeholder="Check-out">
                    <br>
                    <div class="form_group">
                </div>
                             <br>
                             <b>Phone:</b><input type="text"name="tel"placeholder="07****"><br>
                             <a href="pay-Now.php">confirm payment now</a>
                <br>
                <br>
                <br>
